...
⬆️ [Go to main menu](README.md#Laravel-Tips-and-Tricks) ⬅️ [Previous (Views)](views.md) ➡️ [Next (Validation)](validation.md)
...
Tip is based on [suggestion](https://github.com/LaravelDaily/Laravel-Tips-and-Tricks/pull/57) by [MimisK13](https://github.com/MimisK13)
